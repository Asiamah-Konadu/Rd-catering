...
export default async function MenuPage() {
  ...
  return <main className="page"><div className="page-heading"><span className="eyebrow">Rich-Dons Catering</span><h1>Our menu</h1><p>Fresh favourites and simple choices. Add what you want to your bag.</p></div>
